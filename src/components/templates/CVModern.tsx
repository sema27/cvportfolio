...
export function CVModern({ data }: { data: CVData }) {
  ...
  return (
    <div className="min-h-full flex flex-col font-sans text-slate-800">
      ...
      <header className="bg-slate-900 text-white px-8 py-6">
        ...
        {personal.title && (
          <p className="text-amber-300 text-sm mt-1">{personal.title}</p>
        )}
        <div className="flex flex-wrap gap-x-4 gap-y-1 mt-3 text-slate-300 text-sm">
          ...
          {personal.linkedin && (
            <a href={personal.linkedin} className="text-amber-300 hover:underline" target="_blank" rel="noopener noreferrer">
              LinkedIn
            </a>
          )}
          {personal.website && (
            <a href={personal.website} className="text-amber-300 hover:underline" target="_blank" rel="noopener noreferrer">
              Web
            </a>
          )}
        </div>
      ...
      <div className="flex-1 px-8 py-6 space-y-5">
        {personal.summary && (
          <section>
            <h2 className="text-xs font-display font-semibold uppercase tracking-wider text-amber-600 border-b border-amber-600/30 pb-1 mb-2">
              Özet
            </h2>
